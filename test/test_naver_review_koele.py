...
def main(file_path='review_total.csv', save_path=None):
    ...
    df_org.to_csv("../src/data/3/koelectra/org_ele_train_s1000_3.csv", index=False)
    ...
    bt.to_csv("../src/data/3/koelectra/bt_ele_train_s1000_3.csv", index=False)
    ...
    rs.to_csv("../src/data/3/koelectra/rs_ele_train_s1000_3.csv", index=False)
    ...
    ri.to_csv("../src/data/3/koelectra/ri_ele_train_s1000_3.csv", index=False)
    ...
    rd.to_csv("../src/data/3/koelectra/rd_ele_train_s1000_3.csv", index=False)
    ...
    sr.to_csv("../src/data/3/koelectra/sr_ele_train_s1000_3.csv", index=False)
    ...
    noise.to_csv("../src/data/3/koelectra/noise_ele_train_s1000_3.csv", index=False)
    ...
    total.to_csv("../src/data/3/koelectra/total_ele_train_s1000_3.csv", index=False)
