...
def main(file_path='review_total.csv', save_path=None):
    ...
    df_org.to_csv("../src/data/3/multilingual/org_mul_train_s1000_3.csv", index=False)
    ...
    row_list_bt = []
    df_nottok_bt = pd.read_csv("../src/data/bt_nottok_train_s1000_3.csv", index_col=False)
    ...
    bt.to_csv("../src/data/3/multilingual/bt_mul_train_s1000_3.csv", index=False)
    ...
    rs.to_csv("../src/data/3/multilingual/rs_mul_train_s1000_3.csv", index=False)
    ...
    ri.to_csv("../src/data/3/multilingual/ri_mul_train_s1000_3.csv", index=False)
    ...
    rd.to_csv("../src/data/3/multilingual/rd_mul_train_s1000_3.csv", index=False)
    ...
    sr.to_csv("../src/data/3/multilingual/sr_mul_train_s1000_3.csv", index=False)
    ...
    noise.to_csv("../src/data/3/multilingual/noise_mul_train_s1000_3.csv", index=False)
    ...
    total.to_csv("../src/data/3/multilingual/total_mul_train_s1000_3.csv", index=False)
    print(f"Checking : length of origin + bt data {len(total)}")

if __name__ == '__main__':
    path = "../src/data/ratings_train_s1000_3.csv"
    main(file_path=path)