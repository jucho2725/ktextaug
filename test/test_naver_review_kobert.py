...
def main(file_path='review_total.csv', save_path=None):
    ...
    df_org.to_csv("../src/data/3/kobert/org_kob_train_s1000_3.csv", index=False)
    ...
    bt.to_csv("../src/data/3/kobert/bt_kob_train_s1000_3.csv", index=False)
    ...
    rs.to_csv("../src/data/3/kobert/rs_kob_train_s1000_3.csv", index=False)
    ...
    ri.to_csv("../src/data/3/kobert/ri_kob_train_s1000_3.csv", index=False)
    ...
    rd.to_csv("../src/data/3/kobert/rd_kob_train_s1000_3.csv", index=False)
    ...
    sr.to_csv("../src/data/3/kobert/sr_kob_train_s1000_3.csv", index=False)
    ...
    noise.to_csv("../src/data/3/kobert/noise_kob_train_s1000_3.csv", index=False)
    ...
    total.to_csv("../src/data/3/kobert/total_kob_train_s1000_3.csv", index=False)
